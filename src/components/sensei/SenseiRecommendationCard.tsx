            ...
            {isEditing ? (
              ...
              <>
                <button
                  ...
                  className="px-3 py-1.5 bg-white text-black font-bold text-xs border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:bg-gray-100 transition-all rounded"
